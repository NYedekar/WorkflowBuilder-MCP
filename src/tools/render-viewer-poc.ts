...
export type RenderViewerPocInput = z.infer<typeof renderViewerPocSchema>;

export function handleRenderViewerPoc(input: RenderViewerPocInput) {
  return {
    content: [
      {
        type: "text" as const,
        text:
          "Inline 3D POC: a rotating WebGL cube should render directly in the conversation above/with this tool result. " +
