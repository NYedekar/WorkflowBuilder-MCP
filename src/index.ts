    ...
    tools: [
      {
        ...
        description:
          "Builds a workflow DAG from a structured list of intents and their relationships. The AI interface is responsible for extracting intents and detecting relationships from the user prompt before calling this tool.",
        inputSchema: zodToJsonSchema(createWorkflowSchema),
      },
      {
        name: "export_workflow",
        description:
          "Serializes a WorkflowDAG to JSON or YAML. Optionally writes to a file path. Always returns the serialized string.",
