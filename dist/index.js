...
import { applyViewerUpdatesSchema, handleApplyViewerUpdates, } from "./tools/apply-viewer-updates.js";
...
server.setRequestHandler(ListToolsRequestSchema, async () => {
    return {
        tools: [
            ...
            {
                name: "render_massing",
                description: "Render an interactive 3D MASSING view of a model IN THE RIGHT PANEL (prototype). " +
            ...
            {
                name: "render_model",
                description: "THE complete end-to-end tool for viewing any APS/Autodesk model (RVT, DWG, IFC, etc.) in the browser. " +
            ...
            },
            {
                ...
                description: "Apply property edits made in the APS Viewer panel back to the Revit model via Design Automation. " +
            ...
            },
            {
                ...
                description: "Read a local Excel (.xlsx/.xls) OR JSON file containing Revit element parameters and extract structured BIM data. " +
